...
#ifndef FPGANETWORKINTERFACE_H
#define FPGANETWORKINTERFACE_H
...
typedef struct StFpgaLayerInfo
{
	...
	StBlobShape arstInputfeatDim[Max_InputBlob_Num]; //input channel  有问题
	StBlobShape arstOutputfeatDim[Max_InputBlob_Num];//output channel 有问题
