...
env CL_CONTEXT_EMULATOR_DEVICE_ALTERA=1 gdb --args ./bin/host ../host/model/pytorch_resnet50/fpgamodel.bin ../host/model/pytorch_resnet50_q ../host/model/pytorch_resnet50/data.bin ../host/model/pytorch_resnet50/fc1000.bin 1 
#./bin/host ../host/model/resnet50/param.bin ../host/model/resnet50_Q ../host/model/resnet50/data.bin ../host/model/resnet50/fc1000.bin 1
