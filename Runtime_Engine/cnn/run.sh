...
./bin/host ../host/model/resnet50/param.bin ../host/model/resnet50_Q ../host/test_images/ILSVRC2012_val_00000001.JPEG ../host/verify/resnet50_fc1000_label_100.bin 16
